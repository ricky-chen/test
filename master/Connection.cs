...
using System.Configuration;
    ...
    public class DBConnect
    {
        ...
        public DBConnect()
        {
            Byte[] bArray = System.Convert.FromBase64String(ConfigurationManager.AppSettings["myPassword"]);
            String myDecodedPass = Encoding.UTF8.GetString(bArray);
            String myConnectString = ConfigurationManager.ConnectionStrings["myConnectionString"].ToString();
            String SqlConnectString = (myConnectString + myDecodedPass);
            SqlConnectionString = SqlConnectString;
