<%@ Page Title="Post to Blog" Language="C#" MasterPageFile="~/StudentMaster.Master" AutoEventWireup="true" CodeBehind="StudentSubmit.aspx.cs" Inherits="TylerStudentSuccessTracker1.StudentSubmit   " %>
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="PageContent" runat="server">

    <title>Admin Submit Post</title>
    <center><h1 class="h1">Submit Post</h1></center>
    <br />
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-6">
            ...
            <asp:Button ID="Button1" runat="server" Text="Submit" CssClass="btn btn-success btn-lg heading2" OnClick="btnPost_Click" Width="120px" Height="45px" />
            </div>
            <br />
